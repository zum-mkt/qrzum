...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ZRCODE" },
      { name: "description", content: "ZRCODE — Crie, gerencie e rastreie QR Codes dinâmicos com inteligência." },
      { name: "author", content: "ZRCODE" },
      { property: "og:title", content: "ZRCODE" },
      { property: "og:description", content: "ZRCODE — Crie, gerencie e rastreie QR Codes dinâmicos com inteligência." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@zrcode" },
      { name: "twitter:title", content: "ZRCODE" },
      { name: "twitter:description", content: "ZRCODE — Crie, gerencie e rastreie QR Codes dinâmicos com inteligência." },
